...
public class InputNumBState implements State {

    // 数値入力B状態クラスのインスタンス(シングルトン)
    private static InputNumBState inputNumBStateInstance = new InputNumBState();

    /**
     * コンストラクタ
     */
    private InputNumBState() {}

    /**
     * インスタンスのゲッター
     */
    public static State getInputNumBStateInstance() {
        return inputNumBStateInstance;
    }
    ...
    public void onNumBtn(Context context, String inputNum) {
        ...
        // 状態遷移(⇨InputNumBState)
        context.changeState(inputNumBStateInstance);
    }
